...
Each of sample in moving MNIST data has 20 frame of sequential images containing 2 randomly selected handwritten digit from MNIST dataset. In each frame, two digits are moving inside of 64 $/times$ 64
