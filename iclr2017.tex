...
\noindent
Table \ref{tab1} reports the final train and test perplexity values for each investigated model and Figure \ref{fig3} plots the perplexity value vs. the number of epochs for the train and testing sets with and without dropout regularization. Numerical experiments show:
\vspace{-0.25cm}
\begin{enumerate}
...
\cite{zaremba2014recurrent} code\footnotemark[5] + one-hot representation & 34,011,600 & 54.32 & 116.67 \\
