...
%Anonymous submission: authors, acknowledgments, refer to own in third person

\usepackage[utf8]{inputenc} % allow utf-8 input
\usepackage[T1]{fontenc}    % use 8-bit T1 fonts
\usepackage[svgnames]{xcolor}
\usepackage[colorlinks=true,allcolors=DarkBlue]{hyperref} % MidnightBlue, NavyBlue, DarkBlue, Maroon
...
%\title{Structured Sequence Modeling with \\ Recurrent Graph Convolutional Networks}
...
\begin{figure}[t]
	\centering
	\subfigure{\includegraphics[width=0.48\linewidth]{mMNIST_1}}
	\hfill
	\subfigure{\includegraphics[width=0.48\linewidth]{mMNIST_3}}
...
\begin{figure}[t]
	\centering
	\subfigure{\includegraphics[width=0.48\linewidth]{viz_mnist_move}}
	\hfill
	\subfigure{\includegraphics[width=0.48\linewidth]{viz_mnist_move_rot}}
...
\begin{figure}[t]
	\centering
	\subfigure{\includegraphics[width=0.48\linewidth]{fig_ptb_train_small_config}}
	\hfill
	\subfigure{\includegraphics[width=0.48\linewidth]{fig_ptb_test_small_config}}
...
\begin{figure}[t]
	\centering
	\subfigure{\includegraphics[height=5cm]{matrixW}}
	\hspace{0.5cm}
	\subfigure{\includegraphics[height=5cm]{embedding}}
	\vspace{-0.6cm}
